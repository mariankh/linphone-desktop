...
void linphone_core_iterate(LinphoneCore *lc){
	...
	//maria :  here it makes a call.
	while(calls!= NULL){
		//maria - print
		//printf("I am now initiating the process to make a call");
...
#endif //BUILD_UPNP
			//maria here is the initiation e(LinphoneCore *lc, LinphoneCall *call, const LinphoneAddress* destination
...
//maria
printf("linphone_core_start_invite");
	int err;
