...
static const char *parts_content[] = {
	"msd in ANS.1 Per encoding goes here",
	"<presence xmlns=\"urn:ietf:params:xml:ns:xml\" entity=\"sip:francois@sip.linphonecyberattack.fr\">\n"
	"  <tuple id=\"pfaa79\">\n"
	"    <status>\n"
	"      <basic>open</basic>\n"
	"    </status>\n"
...
const char* raw_message = "INVITE sip:500@10.192.11.10 SIP/2.0\r\n"\
							...
							"To: \"ecall\" <sip:500@10.190.11.10>\r\n"\
							"From: \"Maria Terzi\" <sip:6001@10.190.11.10>;tag=7326e5f6\r\n"\
...
content_disposition=belle_sip_header_create("Content-Disposition","by-reference;handling-optional");
		...
		belle_sip_body_handler_add_header(BELLE_SIP_BODY_HANDLER(mbh), content_disposition);
