...
/*
const char* buffer = "INVITE sip:6004@dispark.mooo.com SIP/2.0\r\n"\
...
const char* str1="by-reference;handling-optional";
printf("%s",msd1);
...
//erros have been reported in the past regarding the content length of the SIP message
//please pay attention to the value below
request = BELLE_SIP_REQUEST(message);
belle_sip_message_set_body(BELLE_SIP_MESSAGE(request),desc,15400);
